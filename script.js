                ...
                fetch(`https://jsonplaceholder.typicode.com/comments?postId=` + post.id)
                    ...
                    .then(json => {
                        ...
                        json.forEach(coment => {
                            ...
                            postTitle.innerHTML = `${post.title} <a href='#' class='modal-open' data-bs-toggle="modal" data-bs-target="#modal"  data-coment-id="${post.id}" data-post-title="${post.title}"> (${comentDataLth})</a>`

                        })
                        comentLinks = document.querySelectorAll('a[data-bs-toggle="modal"]')
                        ...
                        comentLinks.forEach(link => {
                            link.onclick = function (e) {
                                ...
                                console.log("ку")
                                modalTitle.textContent = this.getAttribute('data-post-title')
